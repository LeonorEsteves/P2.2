...
function setup() {
  ...
  for (let i = 0; i < 3; i++) {
    _aryInitNoiseXYZ[i] = random(700);
    _aryInitRot[i] = random(500);
  }
...
function draw() {
  //background(200);
	background(350);
  directionalLight(30, 0, 200, -5, 10, -20);
  specularMaterial(0);

  rotateX(_aryInitRot[0] + _count/400);
  rotateY(_aryInitRot[1] + _count/200);
  rotateZ(_aryInitRot[2] + _count/600);
  let freq = 4;
  let d = 2;
